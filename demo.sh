...
echo "Prepreation files- Download the file e.g. Here i am taking two pair end  Demo_1.fq.gz  and Demo_2.fq.gz"
...
fastqc Demo_1.fq.gz  #Done
fastqc Demo_2.fq.gz  #Done
...
# BWA alignment
bwa mem -t 4 -R "@RG\tID:RCL2341\tPL:ILLUMINA\tSM:RCL2341" hg38.fa Demo_1.fq.gz Demo_2.fq.gz > Demo.paired.sam #Done
...
gatk MarkDuplicatesSpark -I Demo.paired.sam -O Demo_sorted_dedup_reads.bam  #Done
...
# 1. build the model
gatk BaseRecalibrator -I Demo_sorted_dedup_reads.bam -R hg38.fa --known-sites Homo_sapiens_assembly38.dbsnp138.vcf  -O recal_data.table #done


# 2. Apply the model to adjust the base quality scores
gatk ApplyBQSR -I Demo_sorted_dedup_reads.bam -R hg38.fa  --bqsr-recal-file recal_data.table -O Demo_sorted_dedup_bqsr_reads.bam #Done
...
gatk CollectAlignmentSummaryMetrics R=hg38.fa I=Demo_sorted_dedup_bqsr_reads.bam O=alignment_metrics.txt #Done
gatk CollectInsertSizeMetrics INPUT=Demo_sorted_dedup_bqsr_reads.bam OUTPUT=insert_size_metrics.txt HISTOGRAM_FILE=insert_size_histogram.pdf #Not Done R is required for this
...
gatk HaplotypeCaller -R hg38.fa -I Demo_sorted_dedup_bqsr_reads.bam -O raw_variants.vcf #Done
